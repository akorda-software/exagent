...
# suite is unaffected. EXAGENT_OFFLINE=1 skips even the DB connection attempt;
# real-provider :integration tests remain excluded by default.
pg_ready =
  if System.get_env("EXAGENT_OFFLINE") == "1" do
    false
  else
    try do
